...
import "./interfaces/ILilypadJobManager.sol";
import "./interfaces/ILilypadJobClient.sol";

contract LilypadClient is Ownable, Initializable, ILilypadJobClient {
  ...
  function runSDXL(
    ...
    inputs[0] = string(abi.encodePacked("PROMPT=", prompt));
    inputs[1] = string(abi.encodePacked("RANDOM_SEED=", seed));
    uint256 id = jobManagerContract.runJob(
        "sdxl:v0.9-lilypad1",
        inputs,
        msg.sender
